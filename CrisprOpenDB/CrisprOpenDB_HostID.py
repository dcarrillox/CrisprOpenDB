...
class PhageHostFinder:
    def __init__(self, blast_db=os.path.join("CrisprOpenDB", "SpacersDB", "SpacersDB"), fasta_db=os.path.join("CrisprOpenDB", "SpacersDB", "SpacersDB.fasta"), sqlite_db=os.path.join("CrisprOpenDB", "SpacersDB", "CrisprOpenDB.sqlite")):
        self._blast_database = blast_db
        self._fasta_database = fasta_db
        self._alignement_results = None
        self._connection = None
        self._sqlite_database = sqlite_db
    ...
    def _findHost(self, args):
        ...
        if self._connection is None:
            self._connection = CrisprOpenDB.CrisprOpenDB(self._sqlite_database)
